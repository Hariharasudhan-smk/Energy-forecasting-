...
with open(r'/Users/hariharasudhan/Downloads/Energy-Forecast-main/synthetic_domestic_energy_data_trained_prophet_model.pkl', 'rb') as f:
    domestic_model = pickle.load(f)

with open(r'/Users/hariharasudhan/Downloads/Energy-Forecast-main/synthetic_industrial_energy_data_trained_prophet_model.pkl', 'rb') as f:
    industrial_model = pickle.load(f)

# Load both synthetic datasets
synthetic_domestic_data = pd.read_csv(r"/Users/hariharasudhan/Downloads/Energy-Forecast-main/synthetic_domestic_energy_data.csv")
synthetic_industrial_data = pd.read_csv(r"/Users/hariharasudhan/Downloads/Energy-Forecast-main/synthetic_industrial_energy_data.csv")
